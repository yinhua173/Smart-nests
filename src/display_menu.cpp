...
//   pinMode(BUTTON_26, INPUT_PULLUP);
//   pinMode(BUTTON_13, INPUT_PULLUP);
//   pinMode(BUTTON_15, INPUT_PULLUP);
//   // 配置中断引脚
//   attachInterrupt(digitalPinToInterrupt(BUTTON_26), handle_interrupt1, FALLING);
//   attachInterrupt(digitalPinToInterrupt(BUTTON_25), handle_interrupt2, FALLING);
//   attachInterrupt(digitalPinToInterrupt(BUTTON_13), handle_interrupt3, FALLING);
//   attachInterrupt(digitalPinToInterrupt(BUTTON_15), handle_interrupt4, FALLING);
// }
// void menu_key(){
//   if(key1_flag) //上
//   {
...
//     u8g2.drawHLine(0, 14, 128);
//     u8g2.setCursor(0, 27);
//     u8g2.printf("温度: %.1f ℃", temp);
//     u8g2.setCursor(0, 40);
//     u8g2.printf("湿度: %d ", humi);
//     u8g2.print("%");
//   } while (u8g2.nextPage()); // 进入下一页，如果还有下一页则返回 True.
// }
